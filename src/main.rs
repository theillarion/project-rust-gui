...
impl MyButton {
    pub fn new(title: &'static str) -> MyButton {
        ...
        match title {
            "=" => {
                b.set_color(Color::from_hex(0x4CC2FF));
                b.set_shortcut(Shortcut::None | Key::Delete);
            }
            "x" | "/" | "+" | "-" | "CE" | "C" | "@<-" => {
                b.set_color(Color::from_hex(0x2D3243));
            ...
            _ => {
                ...
                b.set_label_color(Color::White);
                b.set_selection_color(Color::from_hex(0x01b1b));
                b.set_shortcut(Shortcut::None | title.chars().next().unwrap());
                b.handle(move |b, ev| match ev {
                    Event::Enter => {
                        b.set_color(Color::from_hex(0x02b2b));
                        b.redraw();
                        true
                    }
                    Event::Leave => {
                        b.set_color(Color::from_hex(0x04242));
                        b.redraw();
                        true
                    }
                    _ => false,
...
fn main() {
    ...
    out.set_color(Color::from_hex(0x1A2031));
